...
class DeviceCache {
  ...
  static Future<void> inspectDevice() async {
    ...
    if(_isWeb){
      ...
      DeviceCache.getInstance().systemType = 'iOS';
      ...
      DeviceCache.getInstance().systemType = 'Android';
      ...
      DeviceCache.getInstance().systemType = 'macOS';
      ...
      DeviceCache.getInstance().systemType = 'Windows';
      ...
      DeviceCache.getInstance().systemType = 'Linux';
      DeviceCache.getInstance().systemVersion = '';
